...
<head>
	...
	if ( !function_exists( 'wp_site_icon' ) ) {
		$favicon = trucking_get_config('media-favicon');
...
<body <?php body_class(); ?>>
<?php if ( trucking_get_config('preload') ) { ?>
...
<div id="wrapper-container" class="wrapper-container">
	...
	<?php $header = apply_filters( 'trucking_get_header_layout', trucking_get_config('header_type') );
		if ( empty($header) ) {
			$header = 'default';
		}
	?>
