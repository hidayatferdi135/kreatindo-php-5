							...
							<?php
								$actions = array(
									'download'  => array(
										...
										'name' => esc_html__( 'Download', 'trucking' )
									)
								);
...
<?php else : ?>
	<div class="woocommerce-Message woocommerce-Message--info woocommerce-info">
		<a class="woocommerce-Button button" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); ?>"><?php esc_html_e( 'Go Shop', 'trucking' ) ?></a><?php esc_html_e( 'No downloads available yet.', 'trucking' ); ?>
	</div>
<?php endif; ?>
