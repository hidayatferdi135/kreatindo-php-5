...
class Apus_Themer_Widget_Socials_Widget extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_socials_widget',
            esc_html__('Apus Socials', 'apus-themer'),
            array( 'description' => esc_html__( 'Socials for website.', 'apus-themer' ), )
        );
    ...
    public function scripts() {
        wp_enqueue_script( 'apus-themer-admin', APUS_THEMER_URL.'/assets/admin.js', array( 'jquery' ), APUS_THEMER_VERSION, true );
    }
    ...
    <div class="apus_socials">
        ...
        ?>
                <p>
                <input class="apus-checkbox" type="checkbox" <?php checked( $checked, 1 ); ?> id="<?php echo esc_attr( $key ); ?>"
...
register_widget( 'Apus_Themer_Widget_Socials_Widget' );