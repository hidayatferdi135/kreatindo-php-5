...
class Apus_Themer_Widget_Recent_Post extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_recent_post',
            esc_html__('Apus Recent Posts Widget', 'apus-themer'),
            array( 'description' => esc_html__( 'Show list of recent post', 'apus-themer' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('post_type')); ?>">
                <?php echo esc_html__('Type:', 'apus-themer' ); ?>
            </label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number_post' )); ?>"><?php esc_html_e( 'Num Posts:', 'apus-themer' ); ?></label>
...
register_widget( 'Apus_Themer_Widget_Recent_Post' );