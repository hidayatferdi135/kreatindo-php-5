...
class Apus_Themer_Widget_Search extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_search',
            esc_html__('Apus Search Widget', 'apus-themer'),
            array( 'description' => esc_html__( 'Show search form in sidebar', 'apus-themer' ), )
        );
...
register_widget( 'Apus_Themer_Widget_Search' );