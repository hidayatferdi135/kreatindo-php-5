...
class Apus_Themer_Widget_Facebook_Like_Box extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_facebook_like',
            esc_html__('Apus Facebook Like Box', 'apus-themer'),
            array( 'description' => esc_html__( 'Adds support for Facebook Like Box. ', 'apus-themer' ), )
        );
...
register_widget( 'Apus_Themer_Widget_Facebook_Like_Box' );